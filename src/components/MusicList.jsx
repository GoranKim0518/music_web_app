                ...
                <li key={item.id} ref={ref}>
                    <div className="flex flex-row">
                        ...
                        <div className="flex flex-col ml-[45px] w-[233px]">
                            ...
                            <div className="font-[M PLUS 1p] font-medium text-[13px] text-[#6E6E6E] mb-[5px] max-w-[165px] text-ellipsis block whitespace-nowrap overflow-hidden">{item.artist}</div>
                        </div>
