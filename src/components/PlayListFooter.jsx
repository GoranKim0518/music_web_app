...
export default function PlayListFooter() {
    const { isPlaying, changePlayingState, changeStateToForward, changeStateToBackward } = useContext(State);

    return (
        <div className="flex flex-row items-center">
            <button onClick={changeStateToBackward} className="hover:cursor-pointer">
            ...
            <button onClick={changeStateToForward} className="hover:cursor-pointer">
